...
<div id="container">
    ...
    <form action="/user/signup" method="post">
        <div class="login-box">
            <div id="loginBoxTitle">Signup</div>
            <div class="form-group">
                <label>이름</label>
                <input type="text" name="name" id="name" class="form-control" value="" style="ime-mode:disabled" required>
                <label>이메일 아이디</label>
                <input type="email" name="email" id="email" class="form-control" value="" style="ime-mode:disabled" required>
            </div>
            <div class="form-group">
                <label>비밀번호</label>
            ...
            <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=90c0a4fc42fe93071274c7f5669f12e4&redirect_uri=http://192.168.219.145:8080/user/kakao">
